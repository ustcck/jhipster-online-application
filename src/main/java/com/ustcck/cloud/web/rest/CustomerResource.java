...
import com.ustcck.cloud.domain.Customer;
import com.ustcck.cloud.repository.CustomerRepository;
...
/**
 * REST controller for managing {@link com.ustcck.cloud.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
