package com.ustcck.cloud.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ustcck.cloud.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ustcck.cloud.repository.UserRepository.USERS_BY_EMAIL_CACHE);
